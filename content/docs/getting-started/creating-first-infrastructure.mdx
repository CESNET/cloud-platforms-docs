...
* Active account, see [Accessing G1 Brno site](../technical-reference/brno-g1-site/get-access), [Accessing G2 Ostrava site](../technical-reference/ostrava-g2-site/get-access) and [Accessing G2 Brno site](../technical-reference/brno-g2-site/get-access)
    ...
    <Tab value="GUI">
        ...
        <Tabs items={["Personal project", "Group project"]}>
            <Tab value="Personal project">
                ...
                Here is more information on available networks in [Brno G1](../technical-reference/brno-g1-site/networking#ipv4-personal-floating-ips)
                , [Ostrava G2](../technical-reference/ostrava-g2-site/networking#floating-ip-networks) and  [Brno G2](../technical-reference/brno-g2-site/networking#ipv4-personal-floating-ips).
...
Possible IP address pools are described separately for [Brno G1](../technical-reference/brno-g1-site/networking), [Ostrava G2](../technical-reference/ostrava-g2-site/networking)
and [Brno G2](../technical-reference/brno-g2-site/networking).
