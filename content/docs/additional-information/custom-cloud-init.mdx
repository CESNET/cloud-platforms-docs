...
2. Pass the `cloud-config` to the new instance.
    <Tabs items={["GUI", "CLI"]}>
        <Tab value="GUI">
            ...
            2. Follow the launch steps as described e.g. in the [Create First Instance](../iaas-cloud/getting-started/creating-first-infrastructure#create-a-virtual-machine-instance) guide.
