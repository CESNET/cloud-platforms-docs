...
---
OpenStack supports object storage based on [OpenStack Swift](https://docs.openstack.org/swift/latest/api/object_api_v1_overview.html). Creation of an object storage container (database) is done by clicking on `+Container` on **Object storage containers** page ([G2-Brno](https://horizon.brno.openstack.cloud.e-infra.cz/project/containers/) [G2-Ostrava](https://horizon.ostrava.openstack.cloud.e-infra.cz/project/containers/)).
...
The easiest way to generate **Swift** storage credentials is through **MetaCentrum cloud dashboard** ([G2-Brno](https://horizon.brno.openstack.cloud.e-infra.cz/identity/application_credentials/) [G2-Ostrava](https://horizon.ostrava.openstack.cloud.e-infra.cz/identity/application_credentials/)). You can generate application credentials as described in the [Obtaining API Key](../iaas-cloud/how-to-guides/obtaining-api-key) section.
