...
To avoid this issue, IPv6-only virtual machines must be created with **Configuration Drive** enabled, or deployed as dual-stack instances.

For instructions on how to correctly create dual-stack and IPv6-only virtual machines, see [IPv6 Instances](../iaas-cloud/how-to-guides/ipv6-instances).
