...
Example configuration is available on page [Managing security groups](../iaas-cloud/how-to-guides/managing-security-groups). For full CLI reference please refer to [OpenStack docs](https://docs.openstack.org/python-openstackclient/train/cli/command-objects/security-group.html).
