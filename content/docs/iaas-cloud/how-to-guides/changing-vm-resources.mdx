...
In this guide, we will show you how to change the VM resources by changing **flavor** ([G2-Brno](../technical-reference/brno-g2-site/flavors), [G2-Ostrava](../technical-reference/ostrava-g2-site/flavors)).
