...
All available flavors can be found on [this page](https://prod-msite1-oliver-flavors-page-b163e2.gitlab-pages.ics.muni.cz/), where a periodically updated table of all possible flavors is provided.