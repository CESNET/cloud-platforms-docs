...
* private Masaryk University [registry.gitlab.ics.muni.cz:443](http://registry.gitlab.ics.muni.cz:443)
...
1. The project should have a changelog (either manually written or generated) (for instance [`CHANGELOG.md`](https://gitlab.ics.muni.cz/cloud/cloud-estimate-pi/-/blob/master/CHANGELOG))
