...
<Callout type="warn" title="Caution">
	By the date 1.10.2024, it is necessary to be registered on [MetaCentrum](https://metavo.metacentrum.cz/en/), more information provided on [Necessity of being part of MetaCentrum](metacentrum).
</Callout>
...
If you don't have VO/group or you know nothing about it, please contact the cloud support team (see  [Get Support](./get-support))
