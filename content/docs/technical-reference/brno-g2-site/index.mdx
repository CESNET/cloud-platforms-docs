...
Cloud workload migration from [G1 Brno Cloud instance](./docs/additional-information/g1-deprecation) to [G2 Brno Cloud instance](./brno-g2-site) is planned for 2024.
