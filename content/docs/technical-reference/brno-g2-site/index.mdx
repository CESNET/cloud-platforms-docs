...
Cloud workload migration from [G1 Brno Cloud instance](../brno-g1-site/index) to [G2 Brno Cloud instance](./index) is planned for 2024.
 ...
 * [cloud roadmap and news](./roadmap-news)
