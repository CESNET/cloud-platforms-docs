...
- **Note**: Work in progress. The numbers listed here are not up to date. The page will reflect accurate information once the migration from G1 to G2 is complete.
