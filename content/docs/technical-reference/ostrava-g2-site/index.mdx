...
Ostrava cloud site consists of 22 nodes from [Karolina supercomputer](https://docs.it4i.cz/karolina/compute-nodes/#cloud-compute-node).
...
[Following OpenStack components are available](./ostrava-g2-site/openstack-components).
 ...
 * [List of flavors](./ostrava-g2-site/flavors)
 * [How to get access](./ostrava-g2-site/get-access)
 * [Info on networking](./ostrava-g2-site/networking)
 * [Support](./ostrava-g2-site/get-support)
 * [Info on quotas](./ostrava-g2-site/quota-limits)
 * [Specific FAQ](./ostrava-g2-site/faq)
