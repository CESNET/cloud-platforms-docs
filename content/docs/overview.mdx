...
This section contains mainly operational information about the e-INFRA CZ Openstack Cloud (definition of flavors, networking policy, OpenStack internals) that could be necessary when deploying an infrastructure in Brno or Ostrava site.
  ...
  * [Technical details of **Brno-Ostrava Oliver**  IaaS OpenStack cloud][tech-oliver]
...
[tech-g2-ost]: ./iaas-cloud/technical-reference/ostrava-g2-site/
[tech-g2-brno]: ./iaas-cloud/technical-reference/brno-g2-site/
[tech-oliver]: ./iaas-cloud/technical-reference/oliver-multisite/
