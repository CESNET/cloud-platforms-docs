...
- **Virtual Machines** — Traditional VMs running on KubeVirt using `vm-disk` and `vm-instance` resources, with support for [instance types and profiles](technical-reference/vm-instance-types).
...
<Callout type="info" title="Note">
    If you need full control of VMs, network topology, and custom images, consider the [IaaS Cloud](../overview) instead.
</Callout>
