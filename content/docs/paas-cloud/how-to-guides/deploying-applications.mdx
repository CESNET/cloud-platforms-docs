...
- In the dashboard, navigate to the **Marketplace** or **Catalog**.
...
- Review the description, resource requirements, and configurable parameters.
...
- **Resource sizing** — CPU/memory requests and limits.
...
<Callout type="info" title="Tip">
    Start with small resource sizes for testing. You can scale垂直 or request more quota later.
</Callout>
...
- Return to your **Applications** or **Instances** list.
- Wait for the status to change to **Running** or **Ready**.
