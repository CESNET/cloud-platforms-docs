...
This change doesn’t apply to the new cloud site deployed in the Ostrava. Since the end of 2023 it is possible to request resources in the Ostrava site, see the [documentation](./technical-reference/ostrava-g2-site/get-access).
...
[e-INFRA CZ cloud documentation][general-docs] on [GEN1][g1-docs] and [GEN2 Brno][g2b-docs] clouds discusses most important facts about cloud sites.
...
Self-migration is no longer supported, since the G1 site has been decommissioned.
...
[g1-docs]: ./technical-reference/brno-g1-site/
...
[g2b-flavors]: ./technical-reference/brno-g2-site/flavors